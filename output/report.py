...
def generate_passport(
    ...
    identity_data = [
        ...
        ["Carbon database", "EN 15804 / Ökobaudat"],
        ["Assessment method", "EN 15978 / Finnish MoE 2021"],
    ]
    identity_table = Table(identity_data, colWidths=[7*cm, 10*cm])
    ...
    story.append(Paragraph("2. Sustainability Summary", style_h2))
    total_carbon = carbon_df["carbon_kg_co2e"].sum()
    total_carbon_t = round(total_carbon / 1000, 2)
    carbon_per_m2 = round(total_carbon / floor_area, 1) if floor_area > 0 else 0
    ...
    if benchmark_result:
        ...
        target = f"{benchmark_result['target_per_m2']} kgCO2e/m²"
    ...
    story.append(Paragraph("3. Material Inventory", style_h2))
    mat_summary = (
    ...
    inventory_data = [["Material", "Elements", "Volume m³", "Mass t", "Carbon tCO2e"]]
    ...
    inventory_table = Table(
        inventory_data,
        colWidths=[6*cm, 2.5*cm, 2.5*cm, 2.5*cm, 3.5*cm]
    )
    ...
    story.append(Paragraph("4. Circularity Assessment", style_h2))
    circ_data = (
    ...
    circ_table_data = [["Material", "Score", "Grade", "End of Life Pathway"]]
    ...
    story.append(Paragraph("5. AI Sustainability Recommendations", style_h2))
    story.append(Paragraph(
        "The following recommendations are generated by AI based on "
        "the specific assessment data of this building and aligned "
        "with Finnish and EU sustainability standards.",
        style_small
    ))
    ...
    story.append(Paragraph("6. Material Substitution Suggestions", style_h2))
    for s in substitutions:
        sub_data = [
            ...
            [
                f"Carbon saving: {s['carbon_saving_t']} tCO2e "
    ...
    story.append(Paragraph(
        ...
        "Carbon data source: EN 15804 / Ökobaudat",
        ParagraphStyle(
            "footer",
            fontSize=7,
            textColor=colors.HexColor("#888780"),
